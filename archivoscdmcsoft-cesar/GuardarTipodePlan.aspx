...
<!--UNA LINEA AGREGADA POR: ELCESAR-->
...
<body>
    ...
    <div style="height: 216px">
        ...
        <!--DOS LINEAS AGREGADAS POR: ELCESAR-->
        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="LowercaseLetters, UppercaseLetters"
    TargetControlID="TextBox2" Enabled="True" ValidChars="ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyzüÜáéíóúÁÉÍÓ"/>
